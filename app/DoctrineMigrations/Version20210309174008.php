...
final class Version20210309174008 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE competition (id UUID NOT NULL, host_id UUID DEFAULT NULL, start_date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, end_date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_B50A2CB11FB8D185 ON competition (host_id)');
        $this->addSql('COMMENT ON COLUMN competition.id IS \'(DC2Type:uuid)\'');
        $this->addSql('COMMENT ON COLUMN competition.host_id IS \'(DC2Type:uuid)\'');
        ...
        $this->addSql('CREATE TABLE host (id UUID NOT NULL, competitions_id UUID DEFAULT NULL, credentials_username VARCHAR(255) NOT NULL, credentials_password VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_CF2713FD14B3F5BE ON host (competitions_id)');
        $this->addSql('COMMENT ON COLUMN host.id IS \'(DC2Type:uuid)\'');
        $this->addSql('COMMENT ON COLUMN host.competitions_id IS \'(DC2Type:uuid)\'');
        ...
        $this->addSql('ALTER TABLE competition ADD CONSTRAINT FK_B50A2CB11FB8D185 FOREIGN KEY (host_id) REFERENCES host (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        ...
        $this->addSql('ALTER TABLE host ADD CONSTRAINT FK_CF2713FD14B3F5BE FOREIGN KEY (competitions_id) REFERENCES competition (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE host DROP CONSTRAINT FK_CF2713FD14B3F5BE');
        ...
        $this->addSql('ALTER TABLE competition DROP CONSTRAINT FK_B50A2CB11FB8D185');
